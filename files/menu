...
options=(
"Add User" "Renew User" "Delete User" "User List" "User Lock" "User Unlock" "Monitor SSH/Dropbear" "Expired Users" "Users Not Expired" "Speedtest Server" "Delete & List All Expired Users" "Quit")
